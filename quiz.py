    ...
    if username:
        if st.sidebar.checkbox('Start Quiz'):
            ...
            if level == 'Easy':
                ...
                #points = q1 + q2 + q3 + q4 + q5
                    ...
                    if st.sidebar.button('Submit',key=1):
                        ...
                        quizscore.to_csv('quiz.csv',index=False)
                        if options1 == 'Choose:' or options2 == 'Choose:' or options3 == 'Choose:' or options4 == 'Choose:' or options5 == 'Choose:':
            ...
            if level == 'Medium':
                ...
                st.image('https://devforum-uploads.s3.dualstack.us-east-2.amazonaws.com/uploads/optimized/4X/4/c/a/4cabe4ab181df8c3ccc12716e159a8ddc33898d9_2_690x230.png')
                options10 = st.radio('Question 10',['Choose:','Mitoon','Telenthric','Tinytoon','Minitoon'],horizontal=True,label_visibility='collapsed')
                ...
                if st.sidebar.button('Submit',key=2):
                        ...
                        if options6 == 'Choose:' or options7 == 'Choose:' or options8 == 'Choose:' or options9 == 'Choose:' or options10 == 'Choose:':
                            st.sidebar.error('Not all Questions have been Answered')
            ...
            if level == 'Hard':
                ...
                with hard1:
                    ...
                    options11 = st.radio('Question 11',['Choose:','True','False'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://w0.peakpx.com/wallpaper/112/283/HD-wallpaper-roblox-red-logo-red-brickwall-roblox-logo-online-games-roblox-neon-logo-roblox-thumbnail.jpg')
                    options12 = st.radio('Question 12',['Choose:','True','False'],horizontal=True,label_visibility='collapsed')
                ...
                with hard2:
                    ...
                    st.image('https://w0.peakpx.com/wallpaper/112/283/HD-wallpaper-roblox-red-logo-red-brickwall-roblox-logo-online-games-roblox-neon-logo-roblox-thumbnail.jpg')
                    options13 = st.radio('Question 13',['Choose:','ImaginEngine','DynaBlocks','BloxMaker','GoBlox'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://w0.peakpx.com/wallpaper/112/283/HD-wallpaper-roblox-red-logo-red-brickwall-roblox-logo-online-games-roblox-neon-logo-roblox-thumbnail.jpg')
                    options14 = st.radio('Question 14',['Choose:','True','False'],horizontal=True,label_visibility='collapsed')
                ...
                st.image('https://w0.peakpx.com/wallpaper/112/283/HD-wallpaper-roblox-red-logo-red-brickwall-roblox-logo-online-games-roblox-neon-logo-roblox-thumbnail.jpg')
                options15 = st.radio('Question 15',['Choose:','1','2','3','4'],horizontal=True,label_visibility='collapsed')
                ...
                if st.sidebar.button('Submit',key=3):
                      #points = q1 + q2 + q3 + q4 + q5
                        quizscore.loc[0,username] =0
                        quizscore.to_csv('quiz.csv',index=False)
                        if options11 == 'Choose:' or options12 == 'Choose:' or options13 == 'Choose:' or options14 == 'Choose:' or options15 == 'Choose:':
                                st.sidebar.error('Not all Questions have been Answered')
            ...
            if level == 'X-Treme':
                ...
                with x1:
                    ...
                    options16 = st.radio('Question 16',['Choose:','Robux','Tix','Roblox Points','None of the Aboves'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://wallpapers.com/images/hd/roblox-logo-gtm4wouo6frcras0.jpg')
                    options17 = st.radio('Question 17',['Choose:','11K','21K','31K','41K'],horizontal=True,label_visibility='collapsed')
                ...
                with x2:
                    ...
                    st.image('https://wallpapers.com/images/hd/roblox-logo-gtm4wouo6frcras0.jpg')
                    options18 = st.radio('Question 18',['Choose:','Dire Dominus','Dominus Infernus','Dominus Empurus','Frozen Dominus'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://wallpapers.com/images/hd/roblox-logo-gtm4wouo6frcras0.jpg')
                    options19 = st.radio('Question 19',['Choose:','One Blox','Blox Piece','Bloxy Fruits','None of the aboves'],horizontal=True,label_visibility='collapsed')
                ...
                st.image('https://wallpapers.com/images/hd/roblox-logo-gtm4wouo6frcras0.jpg')
                options20 = st.radio('Question 20',['Choose:','Blizzard','Eagle','Barrier','Rubber'],horizontal=True,label_visibility='collapsed')
                ...
                if st.sidebar.button('Submit',key=4):
                        ...
                        quizscore.loc[0,username] =0
                        quizscore.to_csv('quiz.csv',index=False)
                        if options16 == 'Choose:' or options17 == 'Choose:' or options18 == 'Choose:' or options19 == 'Choose:' or options20 == 'Choose:':
                                st.sidebar.error('Not all Questions have been Answered')
            ...
            if level == 'Impossible':
                ...
                with imp1:
                    ...
                    options21 = st.radio('Question 21',['Choose:','5/27/2023','6/17/2023','7/14/2023','4/29/2023'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://i.pinimg.com/736x/95/ee/e3/95eee32ca5f1395e6763cfce767e7c96.jpg')
                    options22 = st.radio('Question 22',['Choose:','4/12/2008','7/5/2009','6/9/2008','3/28/2008'],horizontal=True,label_visibility='collapsed')
                ...
                with imp2:
                    ...
                    st.image('https://i.pinimg.com/736x/95/ee/e3/95eee32ca5f1395e6763cfce767e7c96.jpg')
                    options23 = st.radio('Question 23',['Choose:','1/2/2021','1/22/2021','2/2/2021','2/22/2021'],horizontal=True,label_visibility='collapsed')
                    ...
                    st.image('https://i.pinimg.com/736x/95/ee/e3/95eee32ca5f1395e6763cfce767e7c96.jpg')
                    options24 = st.radio('Questions 24',['Choose:','9/9/2019','04/03/2020','09/09/2021','01/15/2022'],horizontal=True,label_visibility='collapsed')

                    
                st.subheader('When was Tix Removed')
                st.image('https://i.pinimg.com/736x/95/ee/e3/95eee32ca5f1395e6763cfce767e7c96.jpg')
                options25 = st.radio('Questions 25',['Choose:','9/6/2014','2/17/2015','4/14/2016','4/25/2018'],horizontal=True,label_visibility='collapsed')
            
                if st.sidebar.button('Submit',key=5):
                    #points = q1 + q2 + q3 + q4 + q5
                        quizscore.loc[0,username] =0
                        quizscore.to_csv('quiz.csv',index=False)
                        if options21 == 'Choose:' or options22 == 'Choose:' or options23 == 'Choose:' or options24 == 'Choose:' or options25 == 'Choose:':
                                st.sidebar.error('Not all Questions have been Answered')
